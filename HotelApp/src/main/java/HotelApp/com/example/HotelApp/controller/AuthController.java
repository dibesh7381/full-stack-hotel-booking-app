...
//            cookie.setSameSite("None"); // ✅ cross-origin cookies
//            response.addCookie(cookie);
//
//            return ResponseEntity.ok(
//                    new ApiResponseDTO<>(true, "Login successful", "Token set in HttpOnly cookie")
...
@RequestMapping("/api")
@RequiredArgsConstructor
@CrossOrigin(origins = "https://full-stack-hotel-booking-app-six.vercel.app", allowCredentials = "true")
public class AuthController {
    ...
    public ResponseEntity<ApiResponseDTO<String>> login(
        ...
        try {
            ...
            // ✅ Use ResponseCookie (Spring built-in) to support SameSite and Secure
    ...
    public ResponseEntity<ApiResponseDTO<String>> logout(HttpServletResponse response) {
        ...
        // ✅ Create expired cookie to remove from browser
